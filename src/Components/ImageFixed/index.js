 ...
 */
 ...
 import Image from './Polyfill/polyfill';
 import { StyleSheet } from 'react-native';
 import PropTypes from 'prop-types';
 
 import { getImageSizeFitWidth, getImageSizeFitWidthFromCache } from './Property/cache';
 ...
 export default class ImageFixed extends PureComponent {
   static propTypes = {
     ...ImagePropTypes,
